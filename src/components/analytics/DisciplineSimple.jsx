...
export default function DisciplineSimple({ trades, disciplineScore }) {
  ...
  return (
    <div className="backdrop-blur-md bg-gradient-to-br from-[#1a1a1a]/90 to-[#0d0d0d]/90 rounded-xl border border-[#2a2a2a]/50 p-4 mb-6 col-span-2">
      <h3 className="text-sm font-bold text-[#c0c0c0] mb-4 flex items-center gap-2">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative w-24 h-24 flex-shrink-0">
          <svg className="w-full h-full transform -rotate-90">
            <circle cx="48" cy="48" r="42" stroke="#2a2a2a" strokeWidth="6" fill="none" />
            <circle 
              cx="48" 
              cy="48" 
              r="42" 
              ...
              strokeDashoffset={`${2 * Math.PI * 42 * (1 - disciplineScore / 100)}`}
              strokeLinecap="round"
            />
          </svg>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="text-[10px] text-[#666]">/100</div>
            </div>
          </div>
        </div>
