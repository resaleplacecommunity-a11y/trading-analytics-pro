...
import { Sparkles, BookOpen, Brain, TrendingUp, BarChart3, Plus, X, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function NotesPage() {
  ...
  const deleteCategory = (categoryId) => {
    const isDefaultCategory = DEFAULT_CATEGORIES.some(c => c.id === categoryId);
    ...
    <div className="max-w-full mx-auto space-y-6">
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 items-center">
        {categories.map((cat) => {
          ...
          const isDefaultCategory = DEFAULT_CATEGORIES.some(c => c.id === cat.id);
