...
export default function Dashboard() {
  ...
  const generateLogo = async () => {
    ...
    try {
      const basePrompt = "Ultra-modern premium trading logo for 'Trading Pro'. Design features: 1) Five silver metallic ascending bars forming a rising chart pattern, 2) First four bars are rectangular with same silver metallic texture, smooth gradients from dark silver to bright platinum, 3) Fifth bar (tallest, rightmost) is ALSO silver metallic with SAME texture and shadows as other bars, but topped with a WIDER arrow pointing up, 4) The arrow tip on fifth bar has emerald green (#10b981) glow/light coming from the TOP, 5) Dark charcoal background (#0a0a0a), 6) Brushed metal texture with realistic highlights and shadows for 3D depth on ALL bars including the fifth, 7) Professional, minimalist, luxury fintech aesthetic, 8) Isometric 3D perspective with light coming from top-right, sharp edges, polished surfaces, premium quality, 8K detail.";
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Logo Prompt Input */}
      {showLogoPrompt && (
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0d0d0d] border border-emerald-500/30 rounded-xl p-4 mb-6">
      ...
      {/* New Logo Preview */}
      {newLogoUrl && (
        <div className="bg-gradient-to-br from-emerald-500/20 via-[#0d0d0d] to-emerald-500/10 border-2 border-emerald-500/40 rounded-xl p-6 shadow-[0_0_35px_rgba(16,185,129,0.25)] mb-6">
