    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <main className="lg:ml-64 min-h-screen pt-16 lg:pt-0 relative">
        ...
        <div className="fixed inset-0 lg:left-64 pointer-events-none z-0">
          ...
          {/* Glowing grid - white/green shimmer */}
          ...
          {/* Animated white/silver glows */}
          <div className="absolute top-[15%] right-[25%] w-[700px] h-[700px] bg-gradient-radial from-white/8 via-[#c0c0c0]/4 to-transparent blur-3xl animate-pulse" style={{ animationDuration: '6s' }} />
          <div className="absolute top-[40%] left-[20%] w-[600px] h-[600px] bg-gradient-radial from-[#e5e5e5]/6 via-transparent to-transparent blur-3xl animate-pulse" style={{ animationDuration: '8s', animationDelay: '2s' }} />

          {/* Animated green glows - bottom concentration */}
          <div className="absolute bottom-[5%] left-[15%] w-[800px] h-[800px] bg-gradient-radial from-emerald-500/20 via-emerald-500/10 to-transparent blur-3xl animate-pulse" style={{ animationDuration: '7s', animationDelay: '1s' }} />
          <div className="absolute bottom-[10%] right-[20%] w-[750px] h-[750px] bg-gradient-radial from-green-400/18 via-emerald-500/8 to-transparent blur-3xl animate-pulse" style={{ animationDuration: '9s', animationDelay: '3s' }} />
          <div className="absolute bottom-[2%] left-[45%] w-[700px] h-[700px] bg-gradient-radial from-emerald-400/16 via-green-500/7 to-transparent blur-3xl animate-pulse" style={{ animationDuration: '8s', animationDelay: '4s' }} />
          <div className="absolute bottom-[15%] right-[8%] w-[650px] h-[650px] bg-gradient-radial from-emerald-300/14 via-transparent to-transparent blur-3xl animate-pulse" style={{ animationDuration: '10s', animationDelay: '6s' }} />
        </div>
