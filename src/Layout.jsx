    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <main className="lg:ml-64 min-h-screen pt-16 lg:pt-0 relative">
        ...
        <div className="fixed inset-0 lg:left-64 pointer-events-none z-0">
          ...
          <div className="absolute inset-0 opacity-[0.125]" style={{
          ...
          <div className="absolute top-[30%] left-[25%] w-[700px] h-[700px] bg-gradient-radial from-[#e5e5e5]/5 via-[#c0c0c0]/2.5 to-transparent blur-3xl animate-pulse" style={{ animationDuration: '8s', animationDelay: '2s' }} />
